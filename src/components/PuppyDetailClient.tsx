                  ...
                  {puppy.photos.map((photo, idx) => (
                    <button
                      ...
                      className={`relative w-20 h-20 rounded-lg overflow-hidden border shrink-0 transition-all ${
                        activePhoto === photo ? "border-[#C9A96E]" : "border-[#2A2A2A] hover:border-gray-500"
                      }`}
                    >
            ...
            <div className="space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <span className="bg-[#C9A96E]/10 border border-[#C9A96E]/20 text-[#C9A96E] text-[10px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full">
              ...
              <div className="pt-6">
                <button
                  ...
                  className="w-full bg-[#C9A96E] hover:bg-[#B8965C] text-[#0F0F0F] font-bold py-3.5 rounded-xl transition-all shadow-[0_0_20px_rgba(201,169,110,0.25)] flex items-center justify-center gap-2"
                >
            ...
            <div className="flex border-b border-[#2A2A2A] gap-6 text-sm">
              <button
                ...
                className={`pb-3 font-semibold transition-all border-b-2 ${
                  activeTab === "saude" ? "border-[#C9A96E] text-white" : "border-transparent text-gray-400 hover:text-white"
                }`}
              >
                Saúde &amp; Vacinação
              </button>
              <button
                ...
                className={`pb-3 font-semibold transition-all border-b-2 ${
                  activeTab === "peso" ? "border-[#C9A96E] text-white" : "border-transparent text-gray-400 hover:text-white"
                }`}
              >
                Histórico de Peso
              </button>
              <button
                ...
                className={`pb-3 font-semibold transition-all border-b-2 ${
                  activeTab === "genealogia" ? "border-[#C9A96E] text-white" : "border-transparent text-gray-400 hover:text-white"
                }`}
              >
                Genealogia (Pedigree)
              </button>
              ...
              <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                  ...
                  <div className="bg-[#0F0F0F] border border-[#2A2A2A] p-4 rounded-xl flex flex-col justify-center items-center text-center">
                    <span className="text-[10px] text-[#C9A96E] font-bold uppercase tracking-wider mb-1">Filhote</span>
