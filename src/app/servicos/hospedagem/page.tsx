      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        <section className="space-y-6 max-w-2xl">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">
            Hospedagem &amp; <span className="text-[#C9A96E]">Creche Canina</span>
          </h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {specs.map((s, idx) => (
            <div key={idx} className="bg-[#1A1A1A] border border-[#2A2A2A] p-6 rounded-xl space-y-3 hover:border-[#C9A96E]/30 transition-all">
              <span className="text-[#C9A96E] font-bold text-sm">Estrutura 0{idx + 1}</span>
