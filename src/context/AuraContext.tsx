  ...
  const loadLocalMockData = () => {
    ...
    setFilhotes([
      ...
      },
      {
        ...
        photos: ["/dogs/nero_1.jpg", "/dogs/nero_2.jpg", "/dogs/nero_3.jpg", "/dogs/nero_4.jpg", "/dogs/nero_5.jpg", "/dogs/nero_6.jpg", "/dogs/nero_7.jpg"],
        breed: "Pastor do Cáucaso",
        age: "",
        origin: "Ucrânia",
        weight: "",
      ...
      },
      {
        ...
        origin: "Rússia",
        weight: "",
        notes: "Fêmea robusta importada da Rússia. Temperamento equilibrado e excelente guaraniã.",
        history: "Fêmea importada da Rússia. Estrutura robusta e temperamento equilibrado de guarda. Filha de reprodutores campeões."
      },
      {
        id: 4,
    ...
    setBlogPosts([
      ...
      {
        id: 3,
        title: "Canil Vale da Kubera no Cinofilia Digital: A Revolução do Pastor do Cáucaso no Brasil",
        slug: "revolucao-pastor-do-caucaso-cinofilia-digital",
        excerpt: "Assista à visita do canal Cinofilia Digital ao nosso canil e entenda nossa filosofia de criar cães campeões de pista que também são guardiões territoriais impecáveis.",
        content: "Em uma visita especial conduzida por Sávio do canal Cinofilia Digital, apresentamos a estrutura e a filosofia de criação do Canil Vale da Kubera, liderado por Rafael Avellar e José Carlos. \n\nO grande diferencial do nosso canil é a busca constante pela unificação entre estrutura física (padrão oficial da raça para pistas de exposição) e temperamento de guarda funcional. Conversamos sobre como a cinofilia europeia, mais sólida e tradicional, enxerga o Pastor do Cáucaso: um cão completo. Não há a falsa divisão entre o cão bonito e o cão de guarda. Se o cão possui a estrutura anatômica correta, ele terá saúde, movimentação leve e a funcionalidade ideal para realizar o trabalho de proteção territorial.\n\n### Os Três Pilares do Pastor do Cáucaso\nPara nós, um exemplar ideal da raça precisa combinar perfeitamente três requisitos fundamentais:\n1. **Temperamento:** Cães territorialistas e destemidos com estranhos, mas extremamente equilibrados, dóceis e apegados com a sua família.\n2. **Qualidade Genética:** Seleção rígida com controle radiográfico para evitar problemas como a displasia coxofemoral e hipotireoidismo.\n3. **Estrutura:** Anatomia vigorosa, ossatura maciça e movimentação correta.\n\n### Equilíbrio contra os Extremos (Peso e Tamanho)\nDiscutimos também o perigo do extremismo na criação. Ao contrário de outras raças gigantes como o Mastim Tibetano, que sofreram com a busca exagerada por peso excessivo (gerando cães letárgicos e doentes), o Pastor do Cáucaso deve manter sua agilidade e rusticidade. No auge, nossos reprodutores como o romeno **Boran** chegam perto de 100 kg, mas mantêm movimentação leve, olhos limpos (sem pálpebras pendentes) e vitalidade extrema.\n\n### Destaques do Nosso Plantel\nDurante o vídeo, Sávio conheceu alguns de nossos principais cães:\n- **Boran (Importado da Romênia):** Um exemplar com estrutura maravilhosa, vencedor de 2 *Best in Shows* na Europa antes de chegar ao Brasil.\n- **Afar (Importado da Rússia):** Cão de linhagem 100% funcional de trabalho, filho do lendário campeão russo Taras.\n- **Apolo (Importado da Espanha):** Um macho alto, ágil e com um instinto de ataque e proteção espetaculares.\n- **Putin e Nero:** Os filhotes promissores que representam a renovação constante da nossa genética.\n\n### Maturidade Tardia da Raça\nExplicamos que, diferentemente de raças de trabalho esportivo como o Pastor Belga Malinois (que com poucos meses já persegue brinquedos de forma ativa), o Pastor do Cáucaso tem uma maturação tardia. Um filhote de 3 a 4 meses pode parecer independente e calmo. O cão atinge sua maturidade física e mental de guarda de fato após os 2 anos de idade.\n\nAssista ao vídeo completo no nosso site ou no YouTube para conhecer a fundo nossos cães e nosso compromisso com a raça!",
        tags: ["vídeo", "exposição", "guarda", "linhagem"],
        published: true,
